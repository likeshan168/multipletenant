namespace ultimate.Northwind {
    ...
    export namespace CustomerRow {
        ...
        ['ID', 'CustomerID', 'CompanyName', 'ContactName', 'ContactTitle', 'Address', 'City', 'Region', 'PostalCode', 'Country', 'Phone', 'Fax', 'NoteList', 'Representatives', 'LastContactDate', 'LastContactedBy', 'Email', 'SendBulletin', 'TenantId'].forEach(x => (<any>Fields)[x] = x);
    }
}

...
using Administration = ultimate.Administration.Pages;

[assembly: NavigationMenu(9000, "Administration", icon: "icon-screen-desktop")]
[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: ultimate.Administration.PermissionKeys.Security, icon: "icon-ban", Target = "_blank")]
